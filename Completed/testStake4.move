...
//         let balance = 0x1::BasicTokens::balance_of(from);
//         assert!(balance >= amount, EINSUFFICIENT_BALANCE);
//         assert!(!exists<StakedBalance>(from), EALREADY_STAKED);
//         0x1::BasicTokens::withdraw(from, amount);
...
//         // let coins = 0x1::BasicTokens::Coin { value: staked_amount };
//         let coins = 0x1::BasicTokens::createCoin(staked_amount);



//         0x1::BasicTokens::deposit(from, coins);
...
//         // let coins = 0x1::BasicTokens::Coin { value: reward_amount };
//         let coins = 0x1::BasicTokens::createCoin(reward_amount);
...
//     //     //   let alice = create_account(10000000000);
//     //     //   let bob = create_account(10000000000);
//     //         let alice: signer = 0x11;
//     //         let bob: signer = 0x2;

//     //     // Publish balance for Alice and Bob
//     //     0x1::BasicTokens::publish_balance(&alice);
//     //     0x1::BasicTokens::publish_balance(&bob);

//     //     // Mint some tokens to Alice
//     //     0x1::BasicTokens::mint<BasicTokens::Coin>(&alice, 1000);

//     //     // Alice stakes some tokens
//     //     stake(&alice, 500);

//     //     // Check that Alice's staked balance is correct
//     //     assert!(borrow_global<StakedBalance>(alice).staked_balance == 500, 100);

//     //     // Alice tries to stake again (should fail)
//     //     assert!(stake(&alice, 500), EALREADY_STAKED);

//     //     // Bob tries to unstake from Alice's account (should fail)
//     //     assert!(unstake(&bob, 200), EINSUFFICIENT_STAKE);

//     //     // Alice unstakes some tokens
//     //     unstake(&alice, 200);

//     //     // Check that Alice's staked balance is correct
//     //     assert!(borrow_global<StakedBalance>(alice).staked_balance == 300, 100);

//     //     // Alice claims rewards
//     //     claim_rewards(&alice);

//     //     // Check that Alice's balance has increased by the expected amount
//     //     assert!(0x1::BasicTokens::balance_of(alice) == 800,100);

//     //     // Set a new APY
//     //     set_apy(&alice, 5000);

//     //     // Check that the new APY was set correctly
//     //     assert!(DEFAULT_APY == 5000, 100);
//     //     }
// }
